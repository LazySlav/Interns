...
from .routers.users import get_user # * dummy
from fastapi.security import OAuth2PasswordBearer, OAuth2PasswordRequestForm
from jose import JWTError, jwt
from passlib.context import CryptContext
from pydantic import BaseModel
from .schemas import UserSchema
from .crud import read_entity
from datetime import datetime, timedelta
from typing import Annotated


###### See: https://fastapi.tiangolo.com/tutorial/security/oauth2-jwt/#password-hashing #####
...
SECRET_KEY = "c14e9702bd5f942c7422dec390c41640d86ce25324bf697114a9336ccb955e31" # $ openssl rand -hex 32
ALGORITHM = "HS256"
